 ...
 *
 * Couvre : le regroupement du panneau de notifications par jour relatif, les messages d'empty state
 * distinguant "rien créé encore" de "aucun résultat pour ces filtres" (Congés/Absences, Télétravail,
 * Notes de frais), et le lien "Réinitialiser les filtres" (Salariés, Congés, Organigramme, Télétravail).
 */
...
async function run() {
  ...
  console.log('OK — ameliorations-09-09.test.js (regroupement par jour des notifications, empty states distinguant onboarding et filtres, réinitialisation globale des filtres)');
}
