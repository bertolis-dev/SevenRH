...
// bertolis-tickets/index.ts pour la lecture cross-entreprises). Appelée par le site juste après
// DB.addSupportTicket (data.js), en tâche de fond — un échec d'envoi n'empêche jamais la création
// du ticket côté salarié.
//
